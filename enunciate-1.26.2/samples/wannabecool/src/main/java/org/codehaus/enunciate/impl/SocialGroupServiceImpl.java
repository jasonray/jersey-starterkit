...
import org.codehaus.enunciate.api.ExclusiveGroupException;
import org.codehaus.enunciate.api.SocialGroupService;
import org.codehaus.enunciate.domain.link.SocialGroup;
 ...
 */
@WebService (
  endpointInterface = "org.codehaus.enunciate.api.SocialGroupService"
)
@Path ("/group")
